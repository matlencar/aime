...
public class DataBaseSeeder implements CommandLineRunner {
        ...
        public void run(String... args) throws Exception {
                ...
                Cliente cliente1 = new Cliente(1, "Caio", "caio2132@gmail.com", "4446668881", "445556667", "ola123@",
                                "10/09/1998");
                Cliente cliente2 = new Cliente(2, "Sheila", "sheila1132@gmail.com", "4446668881", "445556667",
                                "ola123@", "13/08/1998");
                Cliente cliente3 = new Cliente(3, "Rubinho", "rubinho1132@gmail.com", "4446668881", "445556667",
                                "ola123@", "21/11/1998");
                clienteRepository.saveAll(List.of(cliente1, cliente2, cliente3));

                EnderecoCliente enderecoCliente1 = new EnderecoCliente(1, "04186100", "Rua das Graças", "SBC", "Brasil",
                                "2", Status.A, "Mercado", cliente1);
                EnderecoCliente enderecoCliente2 = new EnderecoCliente(2, "04156900", "Rua Gonçalves", "São Paulo",
                                "Brasil", "2", Status.A, "Banco", cliente2);
                EnderecoCliente enderecoCliente3 = new EnderecoCliente(3, "04185310", "Avenida Prestes Maia",
                                "Santo andre", "Brasil", "2", Status.A, "Sem complemento", cliente3);
                enderecoClienteRepository.saveAll(List.of(enderecoCliente1, enderecoCliente2, enderecoCliente3));

                TelefoneCliente telefoneCliente1 = new TelefoneCliente(1, "989505723", "011", "+55", Status.A,
                                cliente1);
                TelefoneCliente telefoneCliente2 = new TelefoneCliente(2, "9893605723", "011", "+55", Status.A,
                                cliente2);
                TelefoneCliente telefoneCliente3 = new TelefoneCliente(3, "9893405711", "011", "+55", Status.A,
                                cliente3);
                ...
                EnderecoEmpresa enderEmpresa1 = new EnderecoEmpresa(1, "04187300", "Rua matarazzo", "Osasco", "Brasil",
                                "3", Status.A, "Não tem", empresa1);
                EnderecoEmpresa enderEmpresa2 = new EnderecoEmpresa(2, "04186210", "Rua Joao firmino", "Santo andre",
                                "Brasil", "21", Status.I, "Não tem", empresa2);
                EnderecoEmpresa enderEmpresa3 = new EnderecoEmpresa(3, "04187300", "Rua da patria", "SBC", "Brasil",
                                "10", Status.A, "Não tem", empresa3);
                ...
                TelefoneTransportadora telefoneTransportadora1 = new TelefoneTransportadora(1, "9189115221", "011",
                                "+55", Status.A, transportadora1);
                TelefoneTransportadora telefoneTransportadora2 = new TelefoneTransportadora(2, "9289415272", "011",
                                "+55", Status.A, transportadora2);
                TelefoneTransportadora telefoneTransportadora3 = new TelefoneTransportadora(3, "9389615254", "011",
                                "+55", Status.A, transportadora3);
                telefoneTransportadoraRepository.saveAll(
                                List.of(telefoneTransportadora1, telefoneTransportadora2, telefoneTransportadora3));

                EnderecoTransportadora enderecoTransportadora1 = new EnderecoTransportadora(1, "728374", "alou",
                                "aslou", "brasil", "123", Status.A, "fjhse", transportadora1);
                EnderecoTransportadora enderecoTransportadora2 = new EnderecoTransportadora(2, "728374", "alou",
                                "aslou", "brasil", "123", Status.A, "fjhse", transportadora2);
                EnderecoTransportadora enderecoTransportadora3 = new EnderecoTransportadora(3, "728374", "alou",
                                "aslou", "brasil", "123", Status.A, "fjhse", transportadora3);
                enderecoTransportadoraRepository.saveAll(
                                List.of(enderecoTransportadora1, enderecoTransportadora2, enderecoTransportadora3));
